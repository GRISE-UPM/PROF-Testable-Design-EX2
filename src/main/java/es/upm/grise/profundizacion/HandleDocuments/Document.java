...
public class Document {
	...
	public Document(DocumentIdProvider documentIdProvicer, 
			TemplateFactory templateFactory) throws NonRecoverableError {
		this.documentId = documentIdProvicer.getDocumentId();
